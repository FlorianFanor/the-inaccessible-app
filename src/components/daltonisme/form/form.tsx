  ...
  return (
    <>
      <p className="mb-6 text-gray-800">
        Avant de continuer ton aventure, on va te demander quelques petites
        infos. Rien de bien sorcier, c’est juste un formulaire tout ce qu’il y a
        de plus basique. Tu vas voir, ça va aller vite. Vraiment.
      </p>
