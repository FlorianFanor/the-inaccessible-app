    ...
    <div>
      <div className="mt-20 p-8 max-w-xl mx-auto bg-gray-300">
        ...
        {step === Step.FAVORITE_PRODUCT && (
          <FavoriteProduct setStep={setStep} />
        )}

        {step === Step.CHARTS && <Charts setStep={setStep} />}

        {step === Step.COMMAND_VALIDATION && (
          <CommandValidation setStep={setStep} />
        )}

        {step === Step.FORM && <Form setStep={setStep} />}

        {step === Step.COLOR_TEST && <ColorTest setStep={setStep} />}
